...
from oanda_accessor_pyv20.interface import OandaInterface


@pytest.fixture(name="o_i_instance", scope="module")
...
class TestLoadCandlesByDays:
    def test_short_time_period(
        ...
        with patch(
            "oanda_accessor_pyv20.api.OandaClient.query_instruments",
...
def test_prepare_one_page_transactions(o_i_instance, dummy_raw_open_trades, past_transactions):
    ...
    with patch("oandapyV20.API.request", return_value=dummy_raw_open_trades):
        ...
        with patch(
            "oanda_accessor_pyv20.api.OandaClient.request_transactions_once",
